        ...
        <div class="col s12 m12">
            <div class="card blue-grey darken-1 z-depth-4">
                <div class="card-content white-text">
                    <span class="card-title">Dar de baja profesional</span>
                    
                    <p>Usted ha ingresado a la sesion donde se elimnan los datos de los profesionales que tiene la clinica, en los casos que hay que dar de baja un profesional</p>
