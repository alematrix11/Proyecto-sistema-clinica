...
<head>
    ...
    <title>El profesional no se logro registrar</title>
        ...
        <div class="col s12 m12">
            <div class="card blue-grey darken-1 z-depth-4">
                <div class="card-content white-text">
                    ...
                    <p>No se ha registrado correctamente en el sistema el profesional </p>
                    
                    <br>
                    
                </div>
                <div class="card-action">
                    <a href="../administrador/administrador_valido.php">Regresar a la pagina de panel para un nuevo intento</a>
                </div>
            </div>
        </div>
    </div>
