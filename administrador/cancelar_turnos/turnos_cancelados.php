            ...
            <div class="col l7 m7 s7">
                <div class="nav-wrapper right">
                    <ul class="right hide-on-med-and-down">
                        <li><a class="waves-effect waves-light blue darken-2 btn-large" href="../administrador_valido.php">PANEL</a></li>
        ...
        <div class="col s12 m12">
            <div class="card blue-grey darken-1 z-depth-4">
                <div class="card-content white-text">
                    ...
                    <h2 class="card-title">Se Cancelo el turno correctamente</h2>
                    <p><?php echo  "Se ha cancela el turno de dia: ".$_SESSION['turno_cancelado'] ?></p>
                    <br><br>
