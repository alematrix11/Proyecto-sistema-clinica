...
<head>
    ...
    <title>Contraseñas no validas</title>
        ...
        <div class="col s12 m12">
            <div class="card blue-grey darken-1 z-depth-4">
                <div class="card-content white-text">
                    <span class="card-title">Las contraseñas ingresadas para el registro no coinciden</span>
                    <p>Usted ha ingresado contraseñas que no son las mismas</p>
                    <p>Por favor vuelva a realizar el registro ingresando la misma contraseña</p>
