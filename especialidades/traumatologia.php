...
<head>
    ...
    <title>Solicitando turno - Traumatoligia</title>
        ...
        <div class="col s12 m12">
            <div class="card blue-grey darken-1 z-depth-4">
                ...
                <div class="card-content">
                        ...
                        <p class="white-text">Para poder confirmar el turno con el profesional de traumatología debe seleccionar fecha y hora!</p>
                        <div class="row">
                            
                            <!--Calendario para solicitar turnos 15/11/2019-->
                            <form action="turnos_traumatologia.php" method="POST">
                                ...
                                <div class="input-field col l4 s12">
                                    ...
                                    <!--<input type="text" class="white-text" value="Profesional traumatologia" name="profesional-turno" placeholder="Seleccione la fecha en que desea solicitar el turno" disabled>-->
                                    
                                    <br>
                                    
                                    <div class="input-field col s12 m12">
                                        <select class="icons" name="profesionalId">
                                          <option disabled selected>Seleccione el profesional de Traumatología</option>
                                          <option value="8" data-icon="imagenes/Ignacio%20Dallo.jpg">Ignacio Dallo</option>
                                          <option value="9" data-icon="imagenes/Gabriel%20Gaggiotti%20Pierini.jpg">Gabriel Gaggiotti Pierini</option>
                                        </select>
                                    </div>
