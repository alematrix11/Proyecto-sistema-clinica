...
<head>
    ...
    <title>Solicitando turno - Nutricion</title>
        ...
        <div class="col s12 m12">
            <div class="card blue-grey darken-1 z-depth-4">
                ...
                <div class="card-content">
                        ...
                        <p class="white-text">Para poder confirmar el turno con el profesional de nutricion debe seleccionar fecha y hora!</p>
                        <div class="row">
                            
                            <!--Calendario para solicitar turnos 15/11/2019-->
                            <form action="turnos_nutricion.php" method="POST">
