<?php 
    ...
    if(($resultado_verificacion_id) && ($resultado_verificacion_fecha)){
        ...
        echo 'Ya existe un turno para el paciente con el profesional de la especiliadad de traumatologia y la fecha agregada';
        ...
        $agregar_turno = 'INSERT INTO traumatologia_turnos (id_profesional, id_paciente, fecha, hora) VALUES (?,?,?,?)';
